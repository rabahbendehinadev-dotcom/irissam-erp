import{l as Z,u as z,h as U,A as G,a as Y,r as u,j as e,D as R,T as X,O as J,p as Q,d as q,S as W,B as ee}from"./index-BSlKisi8.js";import{S as te}from"./ScrollableTabBar-B8PGyXYU.js";import{P as se,a as N}from"./PatientAvatar-D4EqGYb5.js";import{a as ae,A as re,P as ie,c as ne,b as le}from"./AdmissionTimeline-DheD1Vs7.js";import{u as oe}from"./usePermission-CHbcjV1a.js";import{u as ce}from"./useAuditLog-B_SmYJjv.js";import{A as B}from"./arrow-left-C_6p4zcd.js";import{A as E}from"./activity-DSb7FhbT.js";import{S as de}from"./square-pen-BW1A75kd.js";import{A as me}from"./arrow-right-BH3PQVeR.js";import{C as xe}from"./clock-DaMmgsx1.js";import{F}from"./file-text-DH-w6iFl.js";import{C as ue}from"./circle-check-Ch5akHab.js";import{M as pe}from"./map-pin-eJ4Rhguc.js";import{C as H}from"./circle-plus-ChwAXqtW.js";import{P as ge}from"./printer-CaTHsAby.js";import"./chevron-right-CdbpgN4j.js";import"./PatientStatusBadge-CLVcZKvs.js";import"./phone-Cb8kCdKu.js";import"./circle-alert-CbxBiYlc.js";import"./info-Dgk1G_e8.js";import"./loader-circle-B6htbzIX.js";import"./check-Cs7YjIXW.js";import"./message-square-DrnKX7e1.js";const he=[["path",{d:"M16 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8Z",key:"qazsjp"}],["path",{d:"M15 3v4a2 2 0 0 0 2 2h4",key:"40519r"}]],V=Z("sticky-note",he);function x(t){return t==null?"":String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}const be={domicile:"Retour à domicile",transfert_interne:"Transfert interne",transfert_externe:"Transfert externe",deces:"Décès",fugue:"Fugue",contre_avis:"Sortie contre avis médical"};function P(t){if(!t)return"—";try{return new Date(t).toLocaleDateString("fr-DZ",{day:"2-digit",month:"long",year:"numeric"})}catch{return t}}function h(t,s){return s?`
    <tr>
      <td class="label">${t}</td>
      <td class="value">${s}</td>
