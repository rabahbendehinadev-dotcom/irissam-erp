...
import {
  ...
  ShieldCheck, BarChart2, FolderArchive, Wallet, Globe, BedDouble
} from "lucide-react";
  ...
  const navGroups = [
    {
      ...
      items: [
        ...
        { path: "/bed-management", icon: BedDouble,       label: "nav.bedManagement" },
      ]
    },
    {
    ...
    {
      label: "nav.group.payroll",
      items: [
        { path: "/payroll", icon: Wallet, label: "nav.payroll" },
      ]
    },
    {
