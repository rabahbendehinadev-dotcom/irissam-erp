...
const TABS = [
  ...
  { key: 'appointments',       labelKey: 'pat.tab.appointments'     },
  { key: 'admissions',         labelKey: 'pat.tab.admissions'       },
  { key: 'consultations',      labelKey: 'pat.tab.consultations'    },
  { key: 'emergencies',        labelKey: 'pat.tab.emergencies'      },
  { key: 'hospitalizations',   labelKey: 'pat.tab.hospitalizations' },
  { key: 'laboratory',         labelKey: 'pat.tab.laboratory'       },
  { key: 'imaging',            labelKey: 'pat.tab.imaging'          },
  { key: 'prescriptions',      labelKey: 'pat.tab.prescriptions'    },
  { key: 'invoices',           labelKey: 'pat.tab.invoices'         },
  { key: 'vaccinations',       labelKey: 'pat.tab.vaccinations'     },
  { key: 'billing',            labelKey: 'pat.tab.billing'          },
  { key: 'payments',           labelKey: 'pat.tab.payments'         },
