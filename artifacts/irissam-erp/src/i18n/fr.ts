export default {
  ...
  "nav.payroll": "Paie / Salaires",
  "nav.group.payroll": "PAIE & RESSOURCES HUMAINES",
  "nav.payroll.dashboard":  "Tableau de bord",
  "nav.payroll.periods":    "Périodes",
  "nav.payroll.runs":       "Runs de paie",
  "nav.payroll.payslips":   "Bulletins",
  "nav.payroll.advances":   "Avances",
  "nav.payroll.loans":      "Prêts",
  "nav.payroll.components": "Composants",
  "nav.payroll.orders":     "Ordres de paiement",
  "nav.payroll.reports":    "Rapports",
  "nav.payroll.settings":   "Paramètres",
  ...
  "exec.title": "Tableau de Bord Direction",
  "exec.subtitle": "Business Intelligence Exécutif",
  "exec.last_update": "Dernière mise à jour",
  "exec.refresh": "Actualiser",
  "exec.pause": "Pause temps réel",
  "exec.resume": "Reprendre temps réel",
  "exec.tab.overview": "Vue d'ensemble",
  "exec.tab.medical": "Activité médicale",
  "exec.tab.capacity": "Capacités",
  "exec.tab.finance": "Finance",
  "exec.tab.hr": "Ressources humaines",
  "exec.tab.stock": "Stock médical",
  "exec.tab.biomedical": "Biomédical",
  "exec.tab.quality": "Qualité & Risques",
  "exec.tab.alerts": "Alertes direction",
  ...
  "pat.tab.portal": "Portail Patient",
  ...
  "pat.action.delete_permanent": "Supprimer définitivement",
  "pat.delete.title": "Suppression définitive du patient",
  "pat.delete.warning": "Cette action est IRRÉVERSIBLE : toutes les données de ce patient seront supprimées de façon permanente.",
  "pat.delete.consequences": "Seront supprimés : épisodes, admissions, consultations, rendez-vous, urgences, hospitalisations, réanimation, bloc opératoire, laboratoire, imagerie, prescriptions, factures, paiements, assurance patient, documents, portail patient, historiques et notifications liés. Les lits, box et ambulances seront libérés.",
  "pat.delete.name": "Nom complet",
  "pat.delete.mpi": "MPI / IPP",
  "pat.delete.file": "N° dossier",
  "pat.delete.continue": "Continuer",
  "pat.delete.cancel": "Annuler",
  "pat.delete.step2.title": "Confirmation finale",
  "pat.delete.step2.desc": "Pour confirmer la suppression définitive, saisissez exactement :",
  "pat.delete.confirm": "Supprimer définitivement",
  "pat.delete.busy": "Suppression en cours…",
  "pat.delete.error": "Échec de la suppression.",
