...
ALTER TABLE departments
  ADD CONSTRAINT IF NOT EXISTS fk_departments_head_doctor
  FOREIGN KEY (head_doctor_id) REFERENCES users(id) ON DELETE SET NULL;

ALTER TABLE departments
  ADD CONSTRAINT IF NOT EXISTS fk_departments_created_by
  FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL;

ALTER TABLE departments
  ADD CONSTRAINT IF NOT EXISTS fk_departments_updated_by
...
ALTER TABLE icu_beds
  ADD CONSTRAINT IF NOT EXISTS fk_icu_beds_icu_admission
...
ALTER TABLE occupancy_beds
  ADD CONSTRAINT IF NOT EXISTS fk_occ_beds_admission
...
ALTER TABLE emergency_visits
  ADD CONSTRAINT IF NOT EXISTS fk_ev_linked_admission
  FOREIGN KEY (linked_admission_id) REFERENCES admissions(id) ON DELETE SET NULL;
ALTER TABLE emergency_visits
  ADD CONSTRAINT IF NOT EXISTS fk_ev_linked_surgical
  FOREIGN KEY (linked_surgical_request_id) REFERENCES surgical_requests(id) ON DELETE SET NULL;
ALTER TABLE emergency_visits
  ADD CONSTRAINT IF NOT EXISTS fk_ev_linked_icu
  FOREIGN KEY (linked_icu_admission_id) REFERENCES icu_admissions(id) ON DELETE SET NULL;
